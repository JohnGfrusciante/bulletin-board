...
ActiveRecord::Schema.define(version: 2020_04_28_181427) do
  ...
  create_table "topic_categories", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "topic_id", null: false
